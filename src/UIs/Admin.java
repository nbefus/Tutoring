                    ...
                    .add(pPanel1Layout.createSequentialGroup()
                        ...
                        .add(pPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                            .add(pPanel1Layout.createSequentialGroup()
                                ...
                                .add(teacherCombo1, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 176, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                .add(categoryLabel1))
                            .add(pPanel1Layout.createSequentialGroup()
                                .add(notesLabel1)
                                .add(18, 18, 18)
                                .add(notesField1, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 191, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                .add(gcCheck1)))
                        .add(pPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                            .add(pPanel1Layout.createSequentialGroup()
