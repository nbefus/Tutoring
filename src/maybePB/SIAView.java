 ...
 * @author shohe_i
 */
public final class SIAViewPB extends javax.swing.JFrame
{
    ...
    public static void main(String args[])
    {
        ...
        {
            java.util.logging.Logger.getLogger(SIAViewPB.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
