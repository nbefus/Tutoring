...
public class Screen1 extends javax.swing.JFrame 
{
    ...
    //set the editor as default on every column
      ...
      //     termslist[i]=terms.get(i).getName();
       ...
       ArrayList<Client> clientPhone = (ArrayList<Client>)HibernateTest.select("from Client as c order by c.phone");
       ArrayList<Client> clientEmail = (ArrayList<Client>)HibernateTest.select("from Client as c order by c.email");
       
       ArrayList<String> clientsfirst = new ArrayList<String>();
       ArrayList<String> clientslast = new ArrayList<String>();
       ArrayList<String> clientsphone = new ArrayList<String>();
       ArrayList<String> clientsemail = new ArrayList<String>();
