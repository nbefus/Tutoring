 ...
 * @author Nathaniel
 */
public class UltimateAutoCompleteTry implements KeyListener, ActionListener, MouseListener
{
    ...
    public UltimateAutoCompleteTry(ArrayList<ArrayList<String>>keywords, JComboBox[] boxes) {
