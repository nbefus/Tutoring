...
public class FakeValues 
{
    ...
    public void tutorSessions()
    {
        ...
        TutorSession ts1 = new TutorSession(getTutorSessions().size(), "sNathaniel", "sBefus", getTutors().get(getTutorSessions().size()), getSubjects().get(getTutorSessions().size()), getTeachers().get(getTutorSessions().size()), 2500, new Timestamp(System.currentTimeMillis()), new Timestamp(System.currentTimeMillis()), new Timestamp(System.currentTimeMillis()), true, false, "Notes!!!");
        getTutorSessions().add(ts1);
        TutorSession ts2 = new TutorSession(getTutorSessions().size(), "sSho", "sShohei", getTutors().get(getTutorSessions().size()), getSubjects().get(getTutorSessions().size()), getTeachers().get(getTutorSessions().size()), 3500, new Timestamp(System.currentTimeMillis()), new Timestamp(System.currentTimeMillis()), new Timestamp(System.currentTimeMillis()), false, true, "Notes!!!");
        ...
        TutorSession ts4 = new TutorSession(getTutorSessions().size(), "sAbe", "sPinada", getTutors().get(getTutorSessions().size()), getSubjects().get(getTutorSessions().size()), getTeachers().get(getTutorSessions().size()), 5500, new Timestamp(System.currentTimeMillis()), new Timestamp(System.currentTimeMillis()), new Timestamp(System.currentTimeMillis()), true, false, "Notes!!!");
