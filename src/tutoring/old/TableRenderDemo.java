...
public class TableRenderDemo extends JPanel {
    ...
    public void setUpSportColumn(JTable table, TableColumn sportColumn) {
        ...
        String[] hey = new String[listSomeString.size()];
        for(int i=0; i<listSomeString.size(); i++)
            hey[i]=listSomeString.get(i);
       // Java2sAutoComboBox comboBox = new Java2sAutoComboBox(listSomeString);
        AutoCompleteComboBox comboBox = new AutoCompleteComboBox(new JComboBox(), hey);
